...
main:   CApp.o CSurface.o CEvent.o CAnimation.o CEntity.o CArea.o CMap.o CTile.o CCamera.o
	$(CXX) -o $@ $^ $(LDLIBS)
clean:
	rm -f $(TARGETS) *.o
...
CApp.o: CApp.cpp CApp.h CSurface.h CEvent.h CAnimation.h CEntity.h CArea.h CMap.h CTile.h CCamera.h Define.h
